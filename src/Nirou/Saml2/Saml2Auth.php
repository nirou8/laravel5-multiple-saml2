...
namespace Nirou\Saml2;

use OneLogin_Saml2_Auth;
use OneLogin_Saml2_Error;
use OneLogin_Saml2_Utils;
use Nirou\Saml2\Events\Saml2LogoutEvent;
...
class Saml2Auth
{
     ...
     */
    function login($indexAcs, $returnTo = null, $parameters = array(), $forceAuthn = false, $isPassive = false, $stay = false, $setNameIdPolicy = true)
    {
        $auth = $this->auth;

        return $auth->login($indexAcs, $returnTo, $parameters, $forceAuthn, $isPassive, $stay, $setNameIdPolicy);
    }
